   ...
   return (
      <>
         <input
            ...
            className={`py-1 focus:outline-none border-b text-[0.5rem] 3xl:text-[0.625rem] text-center xl:text-right 
            placeholder:text-center xl:placeholder:text-right autofill:shadow-[0_0_0px_1000px_#2c2c2c_inset]
