...
export default function ErrorModal({ action }: { action: () => void }) {
   ...
   return (
      ...
      //    <div className="max-w-md text-center flex flex-col items-center bg-[#242424] aspect-square w-[80%] lg:w-[40%] rounded-2xl">
      ...
      //             <p className="text-xl md:text-4xl lg:text-3xl">{t("ops")}</p>
